erpnext.PointOfSale.PastOrderSummary = class {
			...
			if (m.condition) {
				m.visible_btns.forEach(b => {
					...
					this.$summary_btns.append(
						`<div class="summary-btn btn btn-default ${class_name}-btn">${__(b, null, "POS")}</div>`
					);
				});
			}
		});
	...
	get_condition_btn_map(after_submission) {
		...
		//__("Edit Order", null, "POS");
		//__("Delete Order", null, "POS");
		//__("Return", null, "POS");
		//__("Email Receipt", null, "POS");
		//__("Print Receipt", null, "POS");
		//__("New Order", null, "POS");
		//__("Consolidated");
		return [
