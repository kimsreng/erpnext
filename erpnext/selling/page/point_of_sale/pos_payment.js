...
erpnext.PointOfSale.Payment = class {
	...
	bind_events() {
		...
		frappe.ui.form.on("Sales Invoice Payment", "amount", (frm, cdt, cdn) => {
			...
			const mode = frappe.remove_abbr(default_mop.mode_of_payment).replace(/ +/g, "_").toLowerCase();
	...
	render_payment_mode_dom() {
		...
		this.$payment_modes.html(`${
			payments.map((p, i) => {	
				const mode = frappe.remove_abbr(p.mode_of_payment).replace(/ +/g, "_").toLowerCase();
