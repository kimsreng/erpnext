...
def make_supplier_quotation_from_rfq(source_name, target_doc=None, for_supplier=None):
	def postprocess(source, target_doc):
		if for_supplier:
			...
			target_doc.buying_price_list = args.buying_price_list or frappe.get_single_value('Buying Settings', 'buying_price_list')
...
def create_supplier_quotation(doc):
	...
	try:
		sq_doc = frappe.get_doc({
			...
			"buying_price_list": doc.get('buying_price_list') or frappe.get_single_value('Buying Settings', 'buying_price_list')
		})
