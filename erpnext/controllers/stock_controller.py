...
class StockController(AccountsController):
	...
	def validate_qi_submission(self, row):
		...
		action = frappe.company_get_single_value("Stock Settings", "action_if_quality_inspection_is_not_submitted")
	...
	def validate_qi_rejection(self, row):
		...
		action = frappe.company_get_single_value("Stock Settings", "action_if_quality_inspection_is_rejected")
