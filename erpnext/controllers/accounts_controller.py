...
class AccountsController(TransactionBase):
	...
	def make_discount_gl_entries(self, gl_entries):
		enable_discount_accounting = cint(frappe.get_single_value('Accounts Settings', 'enable_discount_accounting'))
	...
	def set_payment_schedule(self):
		...
		if self.doctype in ("Sales Invoice", "Purchase Invoice"):
			...
			automatically_fetch_payment_terms = cint(frappe.get_single_value('Accounts Settings', 'automatically_fetch_payment_terms'))
