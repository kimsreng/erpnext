...
frappe.ui.form.on('Stock Entry', {
	setup: function(frm) {
		...
		frappe.db.get_agent_single_value('Stock Settings', 'sample_retention_warehouse', (r) => {
		...
		frappe.db.get_agent_single_value('Stock Settings', 'disable_serial_no_and_batch_selector')
		.then((value) => {
			if (value) {
