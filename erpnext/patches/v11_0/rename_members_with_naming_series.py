...
def execute():
	...
	old_named_members = frappe.get_all_with_user_permissions("Member", filters = {"name": ("not like", "MEM-%")})
	correctly_named_members = frappe.get_all_with_user_permissions("Member", filters = {"name": ("like", "MEM-%")})
