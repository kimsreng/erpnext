...
def execute():
	...
	reading_params = frappe.get_all_with_user_permissions("Quality Inspection Reading", fields=["distinct specification"])
	...
	template_params = frappe.get_all_with_user_permissions("Item Quality Inspection Parameter", fields=["distinct specification"])
