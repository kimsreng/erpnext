...
def book_deferred_income_or_expense(doc, deferred_process, posting_date=None):
	...
	via_journal_entry = cint(frappe.get_single_value('Accounts Settings', 'book_deferred_entries_via_journal_entry'))
	submit_journal_entry = cint(frappe.get_single_value('Accounts Settings', 'submit_journal_entries'))
	book_deferred_entries_based_on = frappe.get_single_value('Accounts Settings', 'book_deferred_entries_based_on')
...
def process_deferred_accounting(posting_date=None):
	...
	if not cint(frappe.get_single_value('Accounts Settings', 'automatically_process_deferred_accounting_entry')):
		return
